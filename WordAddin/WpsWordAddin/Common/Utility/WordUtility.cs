   ...
   public class WordUtility
    {
        ...
        public static MsWord.Document OpenWord(string wordFullName, bool appVisible = true, string caption = "")
       {
           //创建word应用
           ...
           try
           {
              ...
              //wordApp=(MsWord.Application)System.Runtime.InteropServices.Marshal.GetActiveObject("MsWord.Application");
       ...
       //public static MsWord.Application CreateWordApp(bool appVisible = true, string caption = "")
       //{
       //    MsWord.Application wordApp = null;
       //    try
       //    {
       ...
       //}
        ...
        /// </summary>
        /// <returns></returns>
        public static MsWord.Application GetWordApp()
        {
            return (MsWord.Application)System.Runtime.InteropServices.Marshal.GetActiveObject("MsWord.Application");
        }
       ...
       public static void CompareWordFile(string sourceFile, string targetFile, string compareReult)
       {
           ...
           object comparetarget = MsWord.WdCompareTarget.wdCompareTargetNew;// 比较结果重新创建
           ...
           object SaveToFormat = MsWord.WdSaveFormat.wdFormatDocumentDefault;//保存文档方式
