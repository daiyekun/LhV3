   ...
   public  class WordAddinUtility
    {
       ...
       public void RegEventHandler()
       {
            try
            {
                ...
                WordDocumentHelper.GetVstoObjectDocm().CloseEvent += new MsWord.DocumentEvents2_CloseEventHandler(wordHelper.CloseDocument);
                WordDocumentHelper.GetVstoObjectDocm().ContentControlOnEnter += new MsWord.DocumentEvents2_ContentControlOnEnterEventHandler(wordHelper.ContentControlOnEnter);
                WordDocumentHelper.GetVstoObjectDocm().ContentControlOnExit += new MsWord.DocumentEvents2_ContentControlOnExitEventHandler(wordHelper.ContentControlOnExit);
            }
            catch (Exception ex)
            {
