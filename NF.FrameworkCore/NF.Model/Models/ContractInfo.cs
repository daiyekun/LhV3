...
namespace NF.Model.Models
{
    public partial class ContractInfo
    {
        public ContractInfo()
        {
            ...
            DisputeManagers = new HashSet<DisputeManager>();
        ...
        public string IsWxmsgDate { get; set; }
        public string HtXmnr { get; set; }
        public string Dqjdspr { get; set; }
        ...
        public virtual ICollection<DisputeManager> DisputeManagers { get; set; }
