...
exports.calculateTextPosition = exports.parsePercent = exports.measureText = exports.getLineHeight = exports.adjustTextY = exports.adjustTextX = exports.getBoundingRect = exports.innerGetBoundingRect = exports.getWidth = exports.$override = exports.DEFAULT_FONT = void 0;
...
function defaultMeasureText(text, font) {
    if (!_ctx) {
        _ctx = (0, util_1.createCanvas)().getContext('2d');
    }
    if (_cachedFont !== font) {
