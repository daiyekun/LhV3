...
exports.cloneValue = exports.interpolate2DArray = exports.interpolate1DArray = exports.step = exports.interpolateNumber = void 0;
...
function cloneValue(value) {
    if ((0, util_1.isArrayLike)(value)) {
        ...
        if ((0, util_1.isArrayLike)(value[0])) {
            var ret = [];
            for (var i = 0; i < len; i++) {
...
function guessArrayDim(value) {
    return (0, util_1.isArrayLike)(value && value[0]) ? 2 : 1;
}
var tmpRgba = [0, 0, 0, 0];
var Track = (function () {
...
var Animator = (function () {
    function Animator(target, loop, additiveTo) {
        ...
        this._loop = loop;
        if (loop && additiveTo) {
            (0, util_1.logError)('Can\' use additive animation on looped animation.');
            return;
        }
    ...
    Animator.prototype.when = function (time, props) {
        return this.whenWithKeys(time, props, (0, util_1.keys)(props));
    };
    ...
    Animator.prototype.__changeFinalValue = function (finalProps, trackKeys) {
        trackKeys = trackKeys || (0, util_1.keys)(finalProps);
        for (var i = 0; i < trackKeys.length; i++) {
            var propName = trackKeys[i];
            var track = this._tracks[propName];
            if (!track) {
