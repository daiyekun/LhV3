...
var INHERITABLE_STYLE_ATTRIBUTES_MAP_KEYS = (0, util_1.keys)(INHERITABLE_STYLE_ATTRIBUTES_MAP);
var SELF_STYLE_ATTRIBUTES_MAP = {
    'alignment-baseline': 'textBaseline',
    'stop-color': 'stopColor'
};
var SELF_STYLE_ATTRIBUTES_MAP_KEYS = (0, util_1.keys)(SELF_STYLE_ATTRIBUTES_MAP);
var SVGParser = (function () {
    ...
    SVGParser.prototype.parse = function (xml, opt) {
        opt = opt || {};
        var svg = (0, parseXML_1.parseXML)(xml);
        if (!svg) {
    ...
    SVGParser.prototype._parseNode = function (xmlNode, parentGroup, named, namedFrom, isInDefs, isInText) {
        ...
        if (nodeName === 'defs' || nodeName === 'switch') {
            ...
            if (!isInDefs) {
                ...
                if (parser_1 && (0, util_1.hasOwn)(nodeParsers, nodeName)) {
            ...
            if (parser && (0, util_1.hasOwn)(paintServerParsers, nodeName)) {
    ...
    SVGParser.internalField = (function () {
        nodeParsers = {
            ...
            'path': function (xmlNode, parentGroup) {
                ...
                var path = (0, path_1.createFromString)(d);
...
function inheritStyle(parent, child) {
    if (parent && parent.__inheritedStyle) {
        ...
        (0, util_1.defaults)(child.__inheritedStyle, parent.__inheritedStyle);
    }
}
...
function parseAttributes(xmlNode, el, defsUsePending, onlyInlineStyle, isTextGroup) {
    ...
    if (inheritedStyle.lineDash) {
        disp.style.lineDash = (0, util_1.map)(splitNumberSequence(inheritedStyle.lineDash), function (str) {
...
function getFillStrokeStyle(el, method, str, defsUsePending) {
    ...
    if (urlMatch) {
        var url = (0, util_1.trim)(urlMatch[1]);
...
function parseInlineStyle(xmlNode, inheritableStyleResult, selfStyleResult) {
    ...
    while ((styleRegResult = styleRegex.exec(style)) != null) {
        ...
        var zrInheritableStlAttr = (0, util_1.hasOwn)(INHERITABLE_STYLE_ATTRIBUTES_MAP, svgStlAttr)
            ? INHERITABLE_STYLE_ATTRIBUTES_MAP[svgStlAttr]
            : null;
        if (zrInheritableStlAttr) {
            inheritableStyleResult[zrInheritableStlAttr] = styleRegResult[2];
        }
        var zrSelfStlAttr = (0, util_1.hasOwn)(SELF_STYLE_ATTRIBUTES_MAP, svgStlAttr)
