...
var BezierCurve = (function (_super) {
    (0, tslib_1.__extends)(BezierCurve, _super);
    ...
    BezierCurve.prototype.buildPath = function (ctx, shape) {
        ...
        if (cpx2 == null || cpy2 == null) {
            if (percent < 1) {
                (0, curve_1.quadraticSubdivide)(x1, cpx1, x2, percent, out);
                cpx1 = out[1];
                x2 = out[2];
                (0, curve_1.quadraticSubdivide)(y1, cpy1, y2, percent, out);
                cpy1 = out[1];
                y2 = out[2];
            }
            ...
            if (percent < 1) {
                (0, curve_1.cubicSubdivide)(x1, cpx1, cpx2, x2, percent, out);
                cpx1 = out[1];
                cpx2 = out[2];
                x2 = out[3];
                (0, curve_1.cubicSubdivide)(y1, cpy1, cpy2, y2, percent, out);
                cpy1 = out[1];
                cpy2 = out[2];
                y2 = out[3];
            }
