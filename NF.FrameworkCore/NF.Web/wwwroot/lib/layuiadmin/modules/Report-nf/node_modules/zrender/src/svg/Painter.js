...
var SVGPainter = (function () {
    function SVGPainter(root, storage, opts, zrId) {
        ...
        var svgDom = (0, core_1.createElement)('svg');
        ...
        var bgRoot = (0, core_1.createElement)('g');
        svgDom.appendChild(bgRoot);
        var svgRoot = (0, core_1.createElement)('g');
    ...
    SVGPainter.prototype.setBackgroundColor = function (backgroundColor) {
        ...
        var bgNode = (0, core_1.createElement)('rect');
        bgNode.setAttribute('width', this.getWidth());
        bgNode.setAttribute('height', this.getHeight());
        bgNode.setAttribute('x', 0);
        bgNode.setAttribute('y', 0);
        bgNode.setAttribute('id', 0);
        var _a = (0, core_1.normalizeColor)(backgroundColor), color = _a.color, opacity = _a.opacity;
    ...
    SVGPainter.prototype.createSVGElement = function (tag) {
        return (0, core_1.createElement)(tag);
    };
    ...
    SVGPainter.prototype._paintList = function (list) {
        ...
        var diff = (0, arrayDiff_1["default"])(visibleList, newVisibleList);
        var prevSvgElement;
        ...
        for (var i = 0; i < diff.length; i++) {
            ...
            if (item.removed) {
                for (var k = 0; k < item.count; k++) {
                    ...
                    var svgElement = getSvgElement(displayable);
                    (0, ClippathManager_1.hasClipPath)(displayable) ? removeFromMyParent(svgElement)
