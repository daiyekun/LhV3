...
exports.isCanvasEl = exports.transformCoordWithViewport = exports.transformLocalCoord = void 0;
    ...
    return (oldCoordTheSame && transformer)
        ...
        : (saved.srcCoords = srcCoords,
            saved[transformerName] = inverse
                ? (0, fourPointsTransform_1.buildTransformer)(destCoords, srcCoords)
                : (0, fourPointsTransform_1.buildTransformer)(srcCoords, destCoords));
}
