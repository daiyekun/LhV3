...
exports.DEFAULT_COMMON_ANIMATION_PROPS = exports.DEFAULT_COMMON_STYLE = void 0;
...
var Displayable = (function (_super) {
    (0, tslib_1.__extends)(Displayable, _super);
    ...
    Displayable.prototype.setStyle = function (keyOrObj, value) {
        if (typeof keyOrObj === 'string') {
            ...
            (0, util_1.extend)(this.style, keyOrObj);
        }
        this.dirtyStyle();
        return this;
    };
    Displayable.prototype.dirtyStyle = function (notRedraw) {
        ...
        this.__dirty |= constants_1.STYLE_CHANGED_BIT;
        if (this._rect) {
            this._rect = null;
        }
    };
    ...
    Displayable.prototype.styleChanged = function () {
        return !!(this.__dirty & constants_1.STYLE_CHANGED_BIT);
    };
    Displayable.prototype.styleUpdated = function () {
        this.__dirty &= ~constants_1.STYLE_CHANGED_BIT;
    };
    Displayable.prototype.createStyle = function (obj) {
        return (0, util_1.createObject)(exports.DEFAULT_COMMON_STYLE, obj);
    };
        ...
        if (targetStyle) {
            if (transition) {
                ...
                if (needsRestoreToNormal) {
                    var changedKeys = (0, util_1.keys)(sourceStyle);
                ...
                var targetKeys = (0, util_1.keys)(targetStyle);
    ...
    Displayable.initDefaultProps = (function () {
        ...
        dispProto.__dirty = constants_1.REDRAW_BIT | constants_1.STYLE_CHANGED_BIT;
    })();
    return Displayable;
}(Element_1["default"]));
