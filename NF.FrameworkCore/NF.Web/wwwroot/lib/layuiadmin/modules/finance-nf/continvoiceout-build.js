...
*打开查看页面
**/
    function openview(htId) {
        layer.open({
            type: 2
            , title: '查看详情'
            , content: '/contract/ContractCollection/Detail?Id=' + htId + "&Ftype=0&rand=" + wooutil.getRandom()
            , maxmin: true
            , area: ['60%', '80%']
            , btnAlign: 'c'
   ...
   *打开客户查看页面
   **/
    function opencompview(CompId) {
        layer.open({
            type: 2
            , title: '查看详情'
            , content: '/Company/Customer/Detail?Id=' + CompId + "&rand=" + wooutil.getRandom()
            , maxmin: true
            , area: ['60%', '80%']
            , btnAlign: 'c'
            , skin: "layer-nf-nfskin"
    ...
    //打开对方
    function showCompView() {
        var CompId = $("#CompId").val();
        opencompview(CompId);
    }

    $("#showHtView").click(function () {
        showHtView();
    });
    $("#showCompView").click(function () {
        showCompView();
    });
