  ...
  **/
        ...
        /********************************中标货物清单-begin****************************************************/
            ...
            var attachmentEvent = {
                ...
                add: function () {
                    ...
                    layer.open({
                        ...
                        , yes: function (index, layero) {
                            ...
                            iframeWindow.layui.form.on('submit(' + submitID + ')', function (obj) {
                                wooutil.OpenSubmitForm({
                                    url: 'Tender/WinningItem/ShowView1',
                                    data: obj.field,
                                    table: table,
                                    index: index,
                                    tableId: 'NF-Cargo'
                ...
                batchdel: function () {
                    /// <summary>列表头部-批量删除</summary>
                    wooutil.deleteDatas({ tableId: 'NF-ContAttachment', table: table, url: 'Tender/WinningItem/Delete', nopage: true });
                },
                ...
                tooldel: function (obj) {
                    /// <summary>列表操作栏-删除</summary>
                    ///<param name='obj'>删除数据对象</param>
                    wooutil.deleteInfo({ tableId: "NF-ContAttachment", data: obj, url: 'Tender/WinningItem/Delete', nopage: true });
                },
                tooledit: function (obj) {
                    ///<summary>修改</summary>
                    ///<param name='obj'>修改数据对象</param>
