...
/***********************中标单位-end***************************************************************************************************/
    ...
    table.render({
        elem: '#NF-Cargo',
        url: '/Tender/WinningItem/GetActListByContId?contId=' + contId + '&rand=' + wooutil.getRandom()
    ...
    var attacCargoEvent = {
        ...
        add: function () {
            ...
            layer.open({
                type: 2
                , title: '新建'
                , content: '/Tender/WinningItem/Build'
                , area: ['60%', '80%']
                , btn: ['确定', '取消']
                , btnAlign: 'c'
                , skin: "layer-ext-myskin"
                , yes: function (index, layero) {
                    ...
                    iframeWindow.layui.form.on('submit(' + submitID + ')', function (obj) {
                        ...
                        table.reload('NF-Cargo', {
                            url: '/Tender/WinningItem/ShowView1',//+ '&rand=' + wooutil.getRandom(),
                        });
                        return false;
                    });
                    submit.trigger('click');
        ...
        batchdel: function () {
            /// <summary>列表头部-批量删除</summary>
            wooutil.deleteDatas({ tableId: 'NF-Cargo', table: table, url: '/Tender/WinningItem/Delete', nopage: true });
        },
        ...
        tooldel: function (obj) {
            /// <summary>列表操作栏-删除</summary>
            ///<param name='obj'>删除数据对象</param>
            wooutil.deleteInfo({ tableId: "NF-Cargo", data: obj, url: '/Tender/WinningItem/Delete', nopage: true });
        },
