...
layui.define(['form', 'jquery'], function (exports) { //提示：模块也可以依赖其它模块，如：layui.define('layer', callback);
    ...
    /**
    *我本人为了加小笔头修改了render方法
    *加了layverify = options.verify? " pen" : "", 同时将变量赋给了文本框
    ****/
        ...
        var a = {
            ...
            input: function () {
                ...
                var selectHtml = '<div class="' + TREE_SELECT_CLASS + ' layui-unselect layui-form-select" id="' + TREE_SELECT_ID + '">' +
                    ...
                    ' <input type="text" id="' + TREE_INPUT_ID + '" placeholder="' + placeholder + '" value="" ' +  'readonly="readonly" class="layui-input layui-unselect ' + layverify + '"/>' +
